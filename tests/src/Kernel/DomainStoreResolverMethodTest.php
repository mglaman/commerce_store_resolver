...
class DomainStoreResolverMethodTest extends EntityKernelTestBase {
  ...
  public function testResolverUS() {
    ...
    $request = Request::create('https://mystore.com/shop');
  ...
  public function testResolverCA() {
    // Fake CloudFlare header.
    $request = Request::create('https://ca.mystore.com/shop');
    $this->container->get('request_stack')->push($request);
